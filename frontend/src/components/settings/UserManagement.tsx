            ...
            <div className="flex justify-between items-center mb-6">
                ...
                {canCreateUsers && (
                    <button
                        ...
                        className="bg-primary-500 text-white px-4 py-2 rounded-md hover:bg-primary-600 flex items-center gap-2"
                    >
                        <svg
                            className="w-5 h-5"
                            fill="none"
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="bg-white0 text-white px-4 py-2 rounded-md hover:bg-gray-600 text-sm"
                        >
                            Cancelar
                        </button>
                    </div>
                        ...
                        <tr>
                            <th className="px-6 py-3 text-left">
                                <input
                                    ...
                                    className="w-4 h-4 text-primary-600 border-primary-200 rounded focus:ring-primary-500"
                                />
                            </th>
